...
class UserRegister(Resource):
    ...
    def delete(self):
        ...
        print(f"Delete called by {current_user.id}: {current_user.username} with data: {data}")
...
class UserLogin(Resource):
    def post(self):
        ...
        if this_user and is_correct_password(this_user.pw_salt, this_user.pw_hash, data['password']):
